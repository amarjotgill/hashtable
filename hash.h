...
class HashTable {
    ...
    ******************************************/
   // private variable to keep track if we are in middle of a rehashing or not
   bool m_currentlyHashing;
   void reHash(TABLENAME tablename);
    void createNewHash(TABLENAME tablename);
    void insertHelper(File file);
